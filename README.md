...
## About Me
- 🔭 Currently building production-grade data pipelines and AI-powered analytics products
- 🤖 Most recent work: **DataSense** — a 1M+ row Snowflake/dbt pipeline with RAG-powered anomaly detection
- 📊 Background in SQL-heavy analysis, dashboarding, and warehouse modeling
- 🧠 Comfortable across the full stack: raw messy data → clean pipeline → ML/AI layer → deployed product (backend + frontend)
...
Jun 2024 – Dec 2024  │  Graduate Teaching Assistant @ UT Arlington

Jun 2021 – Nov 2023  │  Data & Reporting Analyst @ Max Healthcare
